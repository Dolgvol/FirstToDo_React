...
const NoteForm = ({note, onSubmit}) => {
    ...
    return <form onSubmit={submit} name="edit-form" className="edit-form">
        <label className="edit-lable" htmlFor="category1">Category</label>
        <select name="category" className="edit-category fill-edit" id="category1" value={category} onChange={e => setCategory(e.target.value)}>
            <option value="Task" className="category-task" id="categoryTask1">Task</option>
            <option value="Random Thought" className="category-thought" id="categoryThought1">Random Thought
            </option>
        ...
        <input className="edit-name fill-edit" id="name1" value={name} onChange={e => setName(e.target.value)}/>

        <label className="edit-lable" htmlFor="content1">Content</label>
        <textarea className="edit-content fill-edit" id="content1" value={content} onChange={e => setContent(e.target.value)}> </textarea>
